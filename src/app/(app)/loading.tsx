import { Panel, Skeleton, SkeletonPageHeader } from "@/components/ui/primitives";
 ...
 *
 * The geometry is the Overview's: a page header, a row of stat tiles, and a
 ...
 * blank space — which is why the routes that are shaped differently
 * (Prospects, Discover, the Studio, Settings, Account, Radar) carry their own
 * loading file rather than inheriting this one.
 *
 * Shimmer, colours and radii all come from `.skeleton` in globals.css, which
 * already drops to a flat fill under `prefers-reduced-motion`.
 */
